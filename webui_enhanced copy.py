...
import gradio as gr
#print(">>> DEBUG: Gradio file:", gr.__file__)
#print(">>> DEBUG: Has Progress:", hasattr(gr, 'Progress'))
...
def parse_srt_file(file_path):
    """Parses an SRT file and extracts text segments robustly."""
...
# --- Ported Multi-Pass Audio Trimming Logic from Enhanced Version ---
...
def trim_audio_wav(file_path, top_db=30, margin_ms=80, max_internal_silence_ms=600, compress_silence_to_ms=200):
    """4-pass post-processing to remove extended silence and trailing noise."""
    try:
